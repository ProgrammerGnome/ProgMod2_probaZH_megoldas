...
public class BookController {
    ...
    public ResponseEntity<BookDto> updateBookById(@PathVariable("id") @Min(1) Long id, @RequestBody @Valid BookDto bookDto) {
        return ResponseEntity.ok().body(bookService.updateBookById(id, bookDto));
    }
